...
ffmpeg -f v4l2 -framerate 30 -video_size 1280x720 -i /dev/video10 -c:v libx264 -preset ultrafast -tune zerolatency -pix_fmt yuv420p -rtsp_transport tcp -f rtsp rtsp://localhost:8554/webcam
